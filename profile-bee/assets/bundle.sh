...
D3_FLAMEGRAPH=https://cdn.jsdelivr.net/gh/spiermar/d3-flame-graph@2.0.3/dist/d3-flamegraph.min.js

BOOTSTRAP_CSS=https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css
D3_FLAMEGRAPH_CSS=https://cdn.jsdelivr.net/gh/spiermar/d3-flame-graph@2.0.3/dist/d3-flamegraph.css
